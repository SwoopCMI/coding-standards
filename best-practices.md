...
Every function in your program should ideally be just two, or three, or four lines long. Each should be transparently obvious. Each should tell a story. And each should lead you to the next in a compelling order. That’s how short your functions should be!

- Daniele Zannotti (With additions from google searches)
